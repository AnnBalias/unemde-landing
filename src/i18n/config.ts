...
export const PAGES = ["home", "guest", "venue", "partner", "faq"] as const;
export type PageId = (typeof PAGES)[number];

export const NAV_LINKS = [
  { href: "/guest", key: "nav.guests", page: "guest", label: "For guests" },
  { href: "/venue", key: "nav.business", page: "venue", label: "For venues" },
  { href: "/partner", key: "nav.partner", page: "partner", label: "Become a Partner" },
...
export const PAGE_META: Record<PageId, { titleKey: string; descKey: string }> = {
  ...
  partner: { titleKey: "meta.partnerTitle", descKey: "meta.partnerDescription" },
