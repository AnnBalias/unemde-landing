...
export const btn =
  "inline-flex items-center justify-center gap-2 rounded-btn px-6 py-3 text-base font-bold leading-[22px] min-h-[50px] transition duration-200 hover:-translate-y-px";
...
export const benefits =
  "mt-6 grid grid-cols-4 gap-4 max-nav:grid-cols-2 max-sm:grid-cols-1";
